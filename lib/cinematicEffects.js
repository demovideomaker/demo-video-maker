...
(function() {
  ...
  // Mark that we're initializing to prevent race conditions
  window._cinematicInitializing = true;
  ...
  window.cinematicControl = {
    ...
    window._cinematicInitializing = false;
  }
  
  // Make setupCinematicEffects available globally for manual retries
  window.setupCinematicEffects = setupCinematicEffects;
  
  // Run setup based on DOM state
  if (document.readyState === 'loading') {
    console.log('[CinematicEffects] DOM still loading, waiting for DOMContentLoaded');
    document.addEventListener('DOMContentLoaded', setupCinematicEffects);
  } else {
    // DOM is already loaded, run immediately
    console.log('[CinematicEffects] DOM ready, setting up immediately');
